...
- **No license keys or seat management.** Lemon Squeezy has both, but [wiring up the License API is three endpoints](/payments/lemon-squeezy-license-key-api/) you have to call yourself.
