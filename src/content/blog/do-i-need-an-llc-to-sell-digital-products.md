...
Picking one is the hard part; wiring it up isn't. [Adding Lemon Squeezy checkout to a static Astro site](/payments/lemon-squeezy-checkout-astro-static-site/) takes two files and no backend — worth knowing before you spend a week deciding whether you're allowed to sell. And if even a MoR signup feels like more paperwork than this month deserves, [Ko-fi wired to PayPal](/payments/getting-paid-without-stripe-kofi-paypal/) is how I took the very first payment with no entity, no underwriting, and no tax registration at all.
